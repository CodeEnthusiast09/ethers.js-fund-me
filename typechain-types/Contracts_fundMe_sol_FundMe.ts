...
export interface Contracts_fundMe_sol_FundMeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MINIMUM_USD"
...
export interface Contracts_fundMe_sol_FundMe extends BaseContract {
  connect(runner?: ContractRunner | null): Contracts_fundMe_sol_FundMe;
  waitForDeployment(): Promise<this>;

  interface: Contracts_fundMe_sol_FundMeInterface;
